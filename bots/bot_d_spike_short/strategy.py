"""Pure Strategy E2 entry decision (short-TTR weather variant).

Same shape as `bots/bot_d_spike/strategy.py`; only difference is the cfg
module reference (TTR window 0-6h instead of 6-12h).
"""
...
from bots.bot_d_spike_short.discovery import SpikeCandidate
